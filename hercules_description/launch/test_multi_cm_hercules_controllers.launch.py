...
def generate_launch_description():
    position_goals = PathJoinSubstitution(
        [
            ...
            "config",
            "test_multi_cm_dual_goal_publishers_config.yaml",
        ]
    )
    ...
    return LaunchDescription(
        [
            ...
            ExecuteProcess(
                cmd=[
                    "ros2 topic pub  -r 10 /hercules_1/base_velocity_controller/cmd_vel_unstamped geometry_msgs/msg/Twist '{linear: {x: 0.4, y: 0.0, z: 0.0}, angular: {x: 0.0, y: 0.0, z: -0.2}}'"
                ],
                shell=True,
            ),
            Node(
            ...
            ExecuteProcess(
                cmd=[
                    "ros2 topic pub  -r 10 /hercules_2/base_velocity_controller/cmd_vel_unstamped geometry_msgs/msg/Twist '{linear: {x: 0.4, y: 0.0, z: 0.0}, angular: {x: 0.0, y: 0.0, z: 0.2}}'"
                ],
                shell=True,
            ),
        ]
