    ...
    return LaunchDescription(
        [
            ...
            Node(
                ...
                name="publisher_port_gripper_controller",
                parameters=[position_goals],
                output={
                    "stdout": "screen",
                    "stderr": "screen",
            ...
            Node(
                package="ros2_controllers_test_nodes",
                executable="publisher_forward_position_controller",
                name="publisher_starboard_gripper_controller",
                parameters=[position_goals],
                output={
                    "stdout": "screen",
                    "stderr": "screen",
            ...
            ExecuteProcess(
                cmd=[
                    "ros2 topic pub  -r 10 /base_velocity_controller/cmd_vel_unstamped geometry_msgs/msg/Twist '{linear: {x: 0.4, y: 0.0, z: 0.0}, angular: {x: 0.0, y: 0.0, z: 0.2}}'"
                ],
                shell=True,
            ),
        ]
